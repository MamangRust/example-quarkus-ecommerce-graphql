...
public class CategoryTotalPriceByIdRepository implements PanacheRepository<Category> {
    ...
    public Uni<List<CategoriesMonthlyTotalPrice>> findMonthlyTotalPriceByCategory(
            Integer categoryId,
            Integer startYear,
            Integer startMonth,
            Integer endYear,
    ...
    public Uni<List<CategoriesYearlyTotalPrice>> findYearlyTotalPriceByCategory(Integer categoryId, Integer year) {
        String sql = """
                WITH
                    yearly_data AS (
                        SELECT
