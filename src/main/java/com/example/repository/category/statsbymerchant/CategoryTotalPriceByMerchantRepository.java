...
public class CategoryTotalPriceByMerchantRepository implements PanacheRepository<Category> {
    ...
    public Uni<List<CategoriesMonthlyTotalPrice>> findMonthlyTotalPriceByMerchant(
            Integer merchantId,
            Integer startYear,
            Integer startMonth,
            Integer endYear,
    ...
    public Uni<List<CategoriesYearlyTotalPrice>> findYearlyTotalPriceByMerchant(Integer merchantId, Integer year) {
        String sql = """
                WITH
                    yearly_data AS (
                        SELECT
