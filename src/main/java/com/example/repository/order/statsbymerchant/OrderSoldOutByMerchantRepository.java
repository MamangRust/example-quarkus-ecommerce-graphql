package com.example.repository.order.statsbymerchant;
...
public class OrderSoldOutByMerchantRepository implements PanacheRepository<Order> {
    ...
    public Uni<List<OrderMonthly>> findMonthlyOrdersByMerchant(Integer merchantId, Integer yearMonth) {
        String sql = """
                WITH
                    date_range AS (
                        SELECT
                    ...
                    monthly_orders AS (
                        ...
                        GROUP BY PARSEDATETIME(FORMATDATETIME(o.created_at, 'yyyy-MM-01'), 'yyyy-MM-01'), o.merchant_id
                    )
                SELECT
    ...
    public Uni<List<OrderYearly>> findYearlyOrdersByMerchant(Integer merchantId, Integer yearMonth) {
        String sql = """
