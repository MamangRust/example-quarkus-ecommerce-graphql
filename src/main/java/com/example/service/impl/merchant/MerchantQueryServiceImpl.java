...
public class MerchantQueryServiceImpl implements MerchantQueryService {
        ...
        @Override
        public Uni<ApiResponsePagination<List<MerchantResponse>>> findAll(FindAllMerchantRequest req) {
                                        ...
                                        return merchantQueryRepository.findMerchants(search, page, size)
                                                        ...
                                                        .eventually(() -> {
                                                                ...
                                                                requestDurationSeconds.record(duration, Attributes.of(
                                                                                AttributeKey.stringKey("operation"),
                                                                                "find_all_merchants"));
                                                                logger.debug("Find all merchants completed in {} seconds",
                                                                                duration);
                                                        });
                                });
        }
        ...
        @Override
        public Uni<ApiResponsePagination<List<MerchantResponseDeleteAt>>> findByActive(FindAllMerchantRequest req) {
                                        ...
                                        return merchantQueryRepository.findActiveMerchants(search, page, size)
                                                        ...
                                                        .eventually(() -> {
                                                                ...
                                                                requestDurationSeconds.record(duration, Attributes.of(
                                                                                AttributeKey.stringKey("operation"),
                                                                                "find_active_merchants"));
                                                                logger.debug("Find active merchants completed in {} seconds",
                                                                                duration);
                                                        });
                                });
        }
        ...
        @Override
        public Uni<ApiResponsePagination<List<MerchantResponseDeleteAt>>> findByTrashed(FindAllMerchantRequest req) {
                                        ...
                                        return merchantQueryRepository.findTrashedMerchants(search, page, size)
                                                        ...
                                                        .eventually(() -> {
                                                                ...
                                                                requestDurationSeconds.record(duration, Attributes.of(
                                                                                AttributeKey.stringKey("operation"),
                                                                                "find_trashed_merchants"));
                                                                logger.debug("Find trashed merchants completed in {} seconds",
                                                                                duration);
                                                        });
                                });
        }
        ...
        public Uni<ApiResponse<MerchantResponse>> findById(Long merchantId) {
                String cacheKey = "merchants:id:" + merchantId;
                                        ...
                                        return merchantQueryRepository.findMerchantById(merchantId)
                                                        ...
                                                        .eventually(() -> {
                                                                ...
                                                                requestDurationSeconds.record(duration, Attributes.of(
                                                                                AttributeKey.stringKey("operation"),
                                                                                "find_merchant_by_id"));
                                                                logger.debug("Find merchant by id completed in {} seconds",
                                                                                duration);
                                                        });
                                });
        }
        ...
        @Override
        public Uni<ApiResponse<MerchantResponse>> findByUserId(Integer userId) {
                ...
                return redisService.getReactive(cacheKey)
                                .chain(cachedJson -> {
                                        ...
                                        logger.info("Cache MISS for key: {}. Fetching from DB.", cacheKey);
                                        long startTime = System.currentTimeMillis();
                                        Span span = tracer.spanBuilder("findMerchantByUserId")
                                                        .setSpanKind(SpanKind.SERVER)
                                                        .setAttribute("service.name", "merchant-service")
                                                        .setAttribute("operation", "find_merchant_by_user_id")
                                                        .setAttribute("merchant.user.id", userId.toString())
                                                        .startSpan();

                                        return merchantQueryRepository.findMerchantByUserId(userId)
                                                        .chain(merchant -> {
                                                                if (merchant == null) {
                                                                        logger.warn("Merchant not found with userId: {}",
                                                                                        userId);
                                                                        span.setStatus(StatusCode.ERROR,
                                                                                        "Merchant not found");
                                                                        span.setAttribute("merchant.found", false);
                                                                        ...
                                                                        throw new NotFoundException(
                                                                                        "Merchant not found with userId: "
                                                                                                        + userId);
                                                                }
                                                                ...
                                                                return redisService
                                                                                ...
                                                                                .map(v -> {
                                                                                        logger.info("Cached merchant for key: {}",
                                                                                                        cacheKey);
                                                                                        logger.info("Successfully found merchant with userId: {} and name: {}",
                                                                                                        userId,
                                                                                                        merchant.getName());
                                                                                        span.setStatus(StatusCode.OK);
                                                        ...
                                                        .onFailure().invoke(e -> {
                                                                logger.error("Error finding merchant by userId: {}",
                                                                                userId, e);
                                                                span.recordException(e);
                                                                span.setStatus(StatusCode.ERROR, e.getMessage());
                                                        ...
                                                        .eventually(() -> {
                                                                ...
                                                                requestDurationSeconds.record(duration, Attributes.of(
                                                                                AttributeKey.stringKey("operation"),
                                                                                "find_merchant_by_user_id"));
                                                                logger.debug("Find merchant by userId completed in {} seconds",
                                                                                duration);
                                                        });
                                });
        }
